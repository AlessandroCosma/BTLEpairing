...
public class MainActivity extends AppCompatActivity {
    ...
    // BluetoothGattServer: utilizzato per configurare il BT server
    private BluetoothGattServer mBluetoothGattServer;
    // BluetoothLeAdvertiser: utilizzato per la trasmissione
    ...
    private void notifyRegisteredDevices(Boolean toggle) {
        ...
        // per ogni dispositivo bluetooth registrato
